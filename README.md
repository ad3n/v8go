...
```go
import v8 "github.com/ad3n/v8go"
```
...
Go Reference & more examples: https://pkg.go.dev/github.com/ad3n/v8go
...
The [v8build](https://github.com/ad3n/v8go/.github/workflow/v8build.yml) workflow upgrades V8 and builds the libraries.
